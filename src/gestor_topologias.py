...
class GestorTopologias:
    ...
    def _es_categorica(self, nombre_col, df_ref=None):
        """Heurística: si el nombre sugiere categórica o tiene pocos valores únicos."""
    ...
    def graficar_mst(self, mst, nombre, nivel):
        ...
        # Colorear por tipo: categórica (naranja) vs numérica (azul)
        ...
        # Etiqueta: nombre real de columna (recortada si es muy larga)
    ...
    def graficar_heatmap(self, df_matriz, nombre, nivel):
        ...
        # Nombres recortados para el eje
    ...
    def graficar_dendrograma(self, df_matriz, nombre, nivel):
        ...
        parche_cat = mpatches.Patch(color="#E65100", label="Categórica (heurística)")
